...
bool Engine::checkInstanceExtensionSupport(std::vector<const char*>* checkExtensions)
{
...
bool Engine::checkDeviceSuitable(VkPhysicalDevice device)
{
...
SwapchainDetails Engine::getSwapChainDetails(VkPhysicalDevice device)
{
...
VkSurfaceFormatKHR Engine::chooseBestSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats)
{
...
VkPresentModeKHR Engine::chooseBestPresentationMode(const std::vector<VkPresentModeKHR>& presentationModes)
{
...
VkExtent2D Engine::chooseSwapExtend(const VkSurfaceCapabilitiesKHR& surfaceCapabilities)
{
...
void Engine::deleteFrameSynchronization()
{
    for (size_t i = 0; i < swapChainImageCount; i++)
    {
